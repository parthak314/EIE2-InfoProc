...
module nios_accelerometer_mm_interconnect_0 (
	...
	wire  [94:0] timer1_s1_agent_rf_source_data;                                                            // timer1_s1_agent:rf_source_data -> timer1_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] timer1_s1_agent_rsp_fifo_out_data;                                                         // timer1_s1_agent_rsp_fifo:out_data -> timer1_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                                     // cmd_mux_006:src_valid -> timer1_s1_agent:cp_valid
	wire  [93:0] cmd_mux_006_src_data;                                                                      // cmd_mux_006:src_data -> timer1_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                                     // timer1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                                   // cmd_mux_006:src_channel -> timer1_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                             // cmd_mux_006:src_startofpacket -> timer1_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                               // cmd_mux_006:src_endofpacket -> timer1_s1_agent:cp_endofpacket
	...
	wire  [93:0] timer1_s1_agent_rp_data;                                                                   // timer1_s1_agent:rp_data -> router_008:sink_data
	...
	wire         timer1_s1_agent_rdata_fifo_src_valid;                                                      // timer1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] timer1_s1_agent_rdata_fifo_src_data;                                                       // timer1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         timer1_s1_agent_rdata_fifo_src_ready;                                                      // avalon_st_adapter_006:in_0_ready -> timer1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                         // avalon_st_adapter_006:out_0_valid -> timer1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                          // avalon_st_adapter_006:out_0_data -> timer1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                         // timer1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                         // avalon_st_adapter_006:out_0_error -> timer1_s1_agent:rdata_fifo_sink_error
